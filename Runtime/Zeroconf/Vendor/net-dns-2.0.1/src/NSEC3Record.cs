...
namespace Makaretu.Dns
{
    ...
    public class NSEC3Record : ResourceRecord
    {
        ...
        public override void ReadData(WireReader reader, int length)
        {
            ...
            Salt = reader.ReadByteLengthPrefixedBytes() ?? System.Array.Empty<byte>();
            NextHashedOwnerName = reader.ReadByteLengthPrefixedBytes() ?? System.Array.Empty<byte>();
        ...
        public override void ReadData(PresentationReader reader)
        {
            ...
            if (salt != "-")
            {
                var decoded = Base16.Decode(salt);
                Salt = decoded != null ? decoded.ToArray() : System.Array.Empty<byte>();
            }
            else
            {
